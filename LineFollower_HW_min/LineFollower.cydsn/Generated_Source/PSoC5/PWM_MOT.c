...
#ifdef PWM_MOT_PWMUDB_genblk1_ctrlreg__REMOVED
    #error PWM_v3_30 detected with a constant 0 for the enable or \
         constant 1 for reset. This will prevent the component from operating.
#endif /* PWM_MOT_PWMUDB_genblk1_ctrlreg__REMOVED */
...
void PWM_MOT_Init(void) 
{
        ...
        ctrl = PWM_MOT_CONTROL & ((uint8)(~PWM_MOT_CTRL_CMPMODE2_MASK)) &
                ((uint8)(~PWM_MOT_CTRL_CMPMODE1_MASK));
    ...
    /* Globally disable the Fixed Function Block chosen */
        ...
        *******************************************************************************/
        void PWM_MOT_SetCompareMode(uint8 comparemode) 
        {
                ...
                /*Clear existing mode */
                PWM_MOT_CONTROL &= ((uint8)(~(PWM_MOT_CTRL_CMPMODE1_MASK |
                                            PWM_MOT_CTRL_CMPMODE2_MASK)));
    ...
    *******************************************************************************/
    uint8 PWM_MOT_ReadCounter(void) 
    {
        ...
        /* It is up to the user code to make sure there isn't already captured data in the FIFO */
          (void)CY_GET_REG8(PWM_MOT_COUNTERCAP_LSB_PTR_8BIT);
...
void PWM_MOT_WritePeriod(uint8 period) 
{
    ...
    *******************************************************************************/
    ...
    {
        return (CY_GET_REG8(PWM_MOT_STATUS_PTR));
    }
